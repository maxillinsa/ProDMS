			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Manage Department Workspaces</h3>
										
										<div class="col-xs-6">

										<label for="form-field-select-3"><b>Select Organization</b></label>
...
loadDept();
			...
			function addept(){
				...
				window.location="newunit.php?deid="+selunit;
			}
			...
			function loadunits(){
				 ...
				 selunit=cbodept;
				 Tvar("divres").innerHTML="";
				  $.post("controller/utility.php", {act: 'loadunits', cbodept: cbodept },
						   function (data) {
