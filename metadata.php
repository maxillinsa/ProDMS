				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
							<i class="ace-icon"><img src="img/meta.png" style="width:50px;height:50px;"></i>	Document Metadata
								<small>
						...
						<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Manage Metadata</h3>
										...
										<label for="form-field-select-3"><b>Select Company</b></label>
															...
															<select class="chosen-select form-control" id="cmcompany" data-placeholder="Choose a Company..." onchange="loadmetadata();">
...
function loadmetadata(){
	...
	Tvar("divres").innerHTML="";
	 $.post("controller/utility.php", {act: 'loadmetadata', cmcompany: cmcompany },
						   function (data) {
 ...
 function loadcountry(dt) {
			...
			function newmetadata(){
				var cmcompany=Tvar("cmcompany").value;
				if(cmcompany==""){
					msgError("Specify company to continue");return;
				}
				
				window.location="newmetadata.php?cid="+cmcompany;
			}
