...
//echo $docrecnolabel;
$folderid=returnQueryValue("select folderid from pro_documents where id=$fileid","folderid");
$viewerid=returnQueryValue("select id from pro_users where usern='$curuser'","id");
$canwrite=getFolderPermission($folderid,$viewerid,"canwrite");
							if($canwrite=="Y"){}else{
								
								echo "<br>&nbsp;&nbsp; <img src='img/stop.png' style='height:100px;width:100px;'>&nbsp;<strong class='red'>You do not have 'write' permission to this file</strong>";
											...
											<div class="tab-content">
												<div id="home" class="tab-pane fade in active">
													<p><div>
														...
														<input type="text" id="txtfileid" placeholder="Unique Identifier no. (Optional)" class="form-control" disabled value="<?php echo $docid; ?>" />
	...
	loadDept();
			...
			function saveFile(){
				...
				if(fieldos==""){
					 ...
					 $.post("controller/filesystem.php", {act: 'editfileapi', txtfileid: txtfileid,cmdept:cmdept,cmunit:cmunit,cmfolder:cmfolder, fileid: fileid },
						   function (data) {
				...
				//	alert(packeddata);
					 ...
					 $.post("controller/filesystem.php", {act: 'editfilewithdataapi', txtfileid: txtfileid,cmdept:cmdept,cmunit:cmunit,cmfolder:cmfolder, packeddata:packeddata, fileid: fileid },
						   function (data) {
