...
$deid=$_GET['id'];
$taskid=$_GET['id'];
$fileid=returnQueryValue("select fileid from pro_user_tasks where id=$taskid","fileid");
										...
										<div class="col-xs-12 col-sm-6">
											<div class="widget-box">
												...
												<div class="widget-body">
													...
													?>
													<label for="form-field-select-2"><b>Task Result (Note)</b></label>

															<textarea class="form-control" name="txtnote" id="txtnote" ></textarea>
														<br>
														
															
													<label for="form-field-select-2"><b>Next Task</b></label>
...
<![endif]-->
	...
	<script src="assets/js/dropzone.min.js"></script>
		...
		function savedata(){
			...
			var txtnote=Tvar("txtnote").value;
			alert(taskid);
			...
			if(cbouser==""){
			 ...
			 $.post("controller/filesystem.php", {fileid: fileid,cbowork: cbowork,act:"assigntasktouserflow", cbouser: cbouser, txtnote: txtnote, taskid: taskid },
						   function (data) {
							   ...
							   if (data.length > 0) {
								...
								// alert(data);
								   ...
								   if(data=="1"){
									   Tvar("cbowork").value="";
									   Tvar("cbouser").value="";
									    apprise("Task escalated and assigned the next user");
