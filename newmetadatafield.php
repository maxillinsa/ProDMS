										...
										<div class="col-xs-12 col-sm-6">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Add Metadata fields</h4>
												...
												<div class="widget-body">
													...
													<label for="form-field-select-1"><b>Field Name *</b></label>
														...
														<input type="text" id="txtfieldname" placeholder="Field name" class="form-control" />
													...
													<label for="form-field-select-1"><b>Field size *</b></label>
														...
														<input type="number" id="txtsize" placeholder="Field lenght" class="form-control" />
														
														</div>
														
															<div>
													<input type="checkbox" id="chkindex"> <label for="form-field-select-1"><b>Index Field</b></label>
...
<![endif]-->
	...
	<script src="assets/js/dropzone.min.js"></script>
		...
		function savedata(){
			...
			//chkindex,txtmetaname,cbodatatype,txtsize
			var schemaid=cid;
			...
			if(txtsize==""){
			 ...
			 $.post("controller/utility.php", {indexkey:indexkey,txtsize:txtsize,txtfieldname: txtfieldname, act: 'savemetadatafield', cbodatatype: cbodatatype,schemaid:schemaid },
						   function (data) {
							   ...
							   if (data.length > 0) {
								  ...
								  // alert(data);
								   ...
								   if(data=="1"){
										window.location="metadatafields.php?mid="+schemaid;
								   }
