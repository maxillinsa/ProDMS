				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
						<i class="ace-icon"><img src="img/gear.png" style="width:50px;height:50px;"></i>		Workflow 
								<small>
						...
						<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Add Workflow Tasks</h3>
...
loadDept();
			...
			function addept(){
				...
				window.location="newtask.php?deid="+selunit;
			}
			...
			function loadunits(){
				 ...
				 selunit=cbodept;
				 Tvar("divres").innerHTML="";
				  $.post("controller/utility.php", {act: 'loadtasktable', cbodept: cbodept },
						   function (data) {
