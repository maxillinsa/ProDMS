				...
				<div class="col-sm-12">
										<div class="widget-box widget-color-blue2">
											<div class="widget-header" style="margin-bottom: 5px;">
												<h4 class="widget-title lighter smaller">Documents</h4>
											</div>
												<div>
												<div class="col-xs-12 col-sm-11 col-md-4">
																	<div class="input-group">
																		<input type="text" class="form-control" name="keywords" id="txtsearch" placeholder="Search for document" />
																		<div class="input-group-btn">
																			<button type="button" class="btn btn-white btn-primary" onclick="searchFile();">
																				<i class="ace-icon fa fa-search icon-on-right bigger-110"></i>
																			</button>
																			&nbsp;
																		
																			<button type="button" class="btn btn-white btn-primary" onclick="refreshpage();" >
																	...
																	<select name="cbolimit" id="cbolimit" onchange="loadUnit();">
												...
												<button type="button" class="btn btn-white btn-primary" onclick="discuss();"><i class="ace-icon fa fa-comments icon-on-right bigger-110"></i> Discuss</button>
											...
											<button type="button" class="btn btn-white btn-primary" onclick="deletefile();" style="margin-left:1px;"><i class="ace-icon glyphicon glyphicon-trash icon-on-right bigger-110"></i> Delete</button>
											
											 
											<button type="button" class="btn btn-white btn-primary" onclick="fileinfo();" style="margin-left:3px;"><i class="ace-icon glyphicon glyphicon-th icon-on-right bigger-110"></i> Document Info</button>
									</div>
									<br>
...
function discuss(){
	...
	if(res=="fins"){
		//str=str.substring(3,1);
		str=replaceAll(selectedfile,"fins_","");
		window.location="discuss.php?id="+str;
...
function replacefile(){
	...
	if(res=="fins"){
		//str=str.substring(3,1);
		str=replaceAll(selectedfile,"fins_","");
		window.location="replacefile.php?id="+str;
...
function mailfile(){
	...
	if(res=="fins"){
		//str=str.substring(3,1);
		str=replaceAll(selectedfile,"fins_","");
		window.location="mailfile.php?id="+str;
