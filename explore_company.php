			...
			<div class="main-content">
				...
				if($num>0){
					...
					do{
						...
						echo "<div class='explorer_folder' onclick='explore(\"$compid\");'><center><img src='img/org.png' style='width:110px;height:100px;'><br>$cmp</center></div>";
...
function explore(cid){
	...
	window.location="explore_department.php?id="+cid;
}
