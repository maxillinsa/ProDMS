				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
							<i class="ace-icon"><img src="img/dept.png" style="width:50px;height:50px;"></i>	Departments
								<small>
						...
						<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Manage Departments</h3>
										...
										<label for="form-field-select-3"><b>Select Company</b></label>
															...
															<select style="" class="chosen-select form-control" id="cmcompany" data-placeholder="Choose a Company..." onchange="loadCompanies();">
