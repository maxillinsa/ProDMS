...
?>
			...
			<div class="main-content">
				...
				<?php 
				$qry="select * from pro_dept_units where deleted='N' and deptid	=$cid";
				$res=mysql_query($qry);
				...
				if($num>0){
					...
					do{
						...
						echo "<div class='explorer_folder' onclick='explore(\"$compid\");'><center><img src='img/workspace.png' style='width:110px;height:100px;'><br>$cmp</center></div>";
...
function explore(cid){
	...
	window.location="managefolder.php?id="+cid;
}
